...
<head>
    ...
    <title>Viết chương trình giải phương trình bậc I: ax + b = 0</title>
    ...
    <div class="d-flex justify-content-center">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <div class="form-group">
                <h1 style="text-transform: uppercase;" class="text-danger">Viết chương trình giải phương trình bậc I: ax
                    + b = 0</h1>
            </div>
            <div class="form-group">
                <label>Số A</label>
            ...
            <div class="form-group">
                ...
                echo "<h4>Phương trình: " . $a . " + " . $b . "x = 0</h4>";
