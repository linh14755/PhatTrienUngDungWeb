...
setcookie("so1", $so1, time() + 3600, "/", "", 0);
setcookie("so2", $so2, time() + 3600, "/", "", 0);
setcookie("pheptinh", $pheptinh, time() + 3600, "/", "", 0);
        ...
        <form>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                       placeholder="Số thứ nhất" name="so1" value="<?php echo $_COOKIE['so1']; ?>" readonly>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="exampleInputPassword1" placeholder="Số thứ hai"
                       name="so2" value="<?php echo $_COOKIE['so2']; ?>" readonly>
            </div>
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="exampleInputPassword2" placeholder="Kết quả"
                       name="ketqua" value="<?php echo $_COOKIE['ketqua']; ?>" readonly>
            </div>
            <div class="form-group">
                <label class="text-primary">Phép tính đã chọn: <?php echo $_COOKIE['pheptinh']; ?></label>
            </div>
            <div class="form-group mt-2">
                <h6>Reload lại trang web để lấy cookie mới nhất</h6>
                <?php
                echo '<pre>';
                print_r($_COOKIE);
                echo '</pre>';
